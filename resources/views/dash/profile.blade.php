                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="last_name" type="text" id="last-name-column"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" type="text" id="first-name-column"
                            ...
                            <form action="" method="post">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon2"><i
                                            class="bi bi-shield-lock"></i></span>
                                    <input name="confirm_password" type="password" class="form-control form-control-xl"

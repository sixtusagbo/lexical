                      ...
                      <form action="" method="post" class="form form-horizontal">
                        <div class="form-body">
                          <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                              <input type="text" id="author" class="form-control" name="author" placeholder="Author" value="<?= $post['author'] ?>">
                            </div>
                            <div class="col-md-4">
                              <label>Body</label>
                            </div>
                            <div class="col-md-8 form-group">
                              <textarea type="textarea" id="body" class="form-control" name="body" placeholder="Body"><?= $post['body'] ?></textarea>
                            </div>
                            <input type="hidden" name="id" value="<?= $post['id'] ?>">
                            <div class="col-sm-12 d-flex justify-content-center">
                              <button type="submit" name="update-post" class="btn btn-dark me-1 mb-1">Update post</button>
                            </div>
                          </div>
                        </div>
                      </form>
                    <?php else : ?>
                      <div class="alert alert-primary">Go back to blog</div>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
